...
elif os.path.isdir('/Users/liyinjie/Desktop/Works/Globle_data/GW_data/GWTC-3'):
    inject_dir='/Users/liyinjie/Desktop/Works/Globle_data/GW_data/GWTC-3/'
elif os.path.isdir('/public1/home/m8s000968/GWdata/post/GWTC-3'):
    inject_dir='/public1/home/m8s000968/GWdata/post/GWTC-3/'
else:
    print(f"文件夹不存在!")
...
def reduced_Double_constraint(params):
    params['constraint2']=np.sign(params['mu_a2']-params['mu_a1'])-1
    params['constraint6']=np.sign(params['mmax2']-params['mmin2']-20)-1
    params['constraint7']=np.sign(params['mmax1']-params['mmin1']-20)-1
    return params
...
def Single_priors():
    ...
    priors.update(dict(
                    ...
                    mmax1 = Uniform(50., 200, 'mmax1', '$m_{\\rm max,1}$'),
                    alpha1 = Uniform(-4, 8., 'alpha1', '$\\alpha,1$'),
                    mu_a1 = Uniform(0., 1., 'mu_a1', '$\\mu_{\\rm a,1}$'),
                    sigma_a1 = Uniform(0.05, 0.5, 'sigma_a1', '$\\sigma_{\\rm a,1}$'),
                    amin1 = 0,
...
def hyper_Single_nospin(dataset,alpha1,mmin1,mmax1,delta1,n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,amin1,mu_a1,sigma_a1,amax1,beta,mu_t,sigma_t,zmin,zeta,gamma):
    z = dataset['z']
    a1,a2,ct1,ct2=dataset['a1'],dataset['a2'],dataset['cos_tilt_1'],dataset['cos_tilt_2']
    m1=dataset['m1']
    m2=dataset['m2']
    hp = Single_mass_pair(m1,m2, alpha1,mmin1,mmax1,delta1,n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,beta)*1/4*llh_z(z,gamma)
    return hp
...
def Rate_selection_function_with_uncertainty(Nobs,mass_spin_model,lgR0,gamma,**kwargs):
    ...
    log_dNdzdmds = np.where(detection_selector, log_dNdz+log_dNdmds, -np.inf)
